...
namespace Repositories
{
    public class ProductRpository : IProductRpository
    {
        ...
        public ProductRpository(ManagerApiContext managerApiContext)
        {
        ...
        {
            var query = _managerApiContext.Products.Where(product =>
        ...
        {
            return await _managerApiContext.Products.FirstOrDefaultAsync(p => p.Id == id);
